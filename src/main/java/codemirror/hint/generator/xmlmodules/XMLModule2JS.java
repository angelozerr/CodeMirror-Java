...
public class XMLModule2JS {
  ...
  public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
    ...
    File out = new File("../_xquery-editor/sidoc/addon/hint/sidoc-modules.js");
  ...
  public void generate(ModuleHandler handler, Properties properties) throws SAXException, IOException {
    int nbModules = 0;
  ...
  private boolean generate(File file, ModuleHandler moduleHandler, Properties properties, int nbModules) throws SAXException, IOException {
    ...
    try {
      ...
      XMLModule2JsonHandler handler = new XMLModule2JsonHandler(moduleHandler, properties);
